      ...
      <Trace page={InterfacePageName.VOTE_PAGE} shouldLogImpression>
        <PageWrapper gap="lg" justify="center">
            ...
            <VoteCard>
              ...
              <CardSection>
                <AutoColumn gap="md">
                  ...
                  >
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>Read more about governance</Trans>
                    </ThemedText.DeprecatedWhite>
                  </ExternalLink>
                </AutoColumn>
              </CardSection>
          ...
          <ThemedText.DeprecatedSubHeader color="text3">
            <Trans>A minimum threshold of 0.25% of the total LUX supply is required to submit proposals</Trans>
